...
const Home: NextPage = () => {
  ...
  return (
    <div>
      <Head>
        <title>Sayohat Agentligi</title>
        <meta name="description" content="sayohat va bron qilish ilovasi, hayot ilovasi va boshqalar" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <link rel="icon" href="/favicon.ico" />
        {/* Meta Tag */}
        <meta property="og:url" content="https://oasis-tour.uz/" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Jadoo Sayohat Agentligi" />
        <meta property="og:description" content="sayohat va bron qilish ilovasi, hayot ilovasi va boshqalar" />
          ...
          <div className="flex">
            <div className="w-full pt-52 lg:w-6/12">
              <h1 className="mb-6 text-sm font-bold uppercase text-accent-2 lg:text-xl">
                Dunyo bo'ylab eng yaxshi yo'nalishlar
              </h1>
              <h2 className="mb-8 font-serif text-2xl leading-tight tracking-tighter text-gray-900 lg:text-[84px] lg:leading-[89px]">
                Sayohat qiling,{' '}
                ...
                va yangi, to'la hayotni boshlang
              </h2>
              <p className="mb-8 max-w-lg text-sm leading-6 text-gray-500 lg:text-base lg:leading-8">
                Wicketni uzoqroq qurib, o'zi o'zini ko'rinishidan zavqlansin. Sportchilar uni yoqtirishadi — bu
                tinglashga berilgan.
              </p>
              <div className="flex">
                <Link href="/">
                ...
                <button className="flex items-center">
                  ...
                  <span className="hidden text-gray-500 lg:block">Demo-ni ijro etish</span>
                </button>
              </div>
            </div>
            <div className="relative hidden h-[764px] w-[783px] pt-24 lg:block">
              <div className="absolute top-44 left-40 z-30 h-[95px] w-[137px]">
                <Image src="/images/plane.png" layout="responsive" width="100%" height="100%" alt="samolyot" />
              </div>
      ...
      <section className="mb-32">
        <div className="relative mx-auto max-w-7xl px-4">
          ...
          <div className="mb-16 flex flex-col text-center">
            <h3 className="mb-2 text-lg uppercase text-gray-500">Toifa</h3>
            <h3 className="font-serif text-4xl uppercase leading-tight text-gray-900 lg:text-5xl lg:leading-snug">
              Biz eng yaxshi xizmatlarni taklif etamiz
            </h3>
          </div>
          <div className="flex flex-wrap text-gray-900">
            <div className="w-full px-8 lg:w-3/12">
              <div className="group relative flex flex-col items-center justify-center rounded-[36px] bg-white text-center shadow-none transition-all duration-300 hover:shadow-great">
                ...
                <h4 className="mb-3 text-xl font-semibold text-gray-900">Hisoblangan ob-havo</h4>
                <h5 className="mb-8 px-0 text-base font-medium text-gray-500 lg:px-8">
                  Wicketni uzoqroq qurib, o'zi o'zini ko'rinishidan zavqlansin.
                </h5>
              </div>
            </div>
            <div className="w-full px-8 lg:w-3/12">
              <div className="group relative flex flex-col items-center justify-center rounded-[36px] bg-white text-center shadow-none transition-all duration-300 hover:shadow-great">
                ...
                <div className="relative mb-6 inline-flex h-28">
                  <div className="absolute z-10 -translate-x-1/2">
                    <Image layout="fixed" width={146} height={133} src="/images/plane.png" alt="samolyot" />
                  </div>
                ...
                <h4 className="mb-3 text-xl font-semibold text-gray-900">Eng yaxshi reyslar</h4>
                <h5 className="mb-8 px-0 text-base font-medium text-gray-500 lg:px-8">
                  Tinglashga berilgan. Park darvozasi g'arbni qiyin sotadi.
                </h5>
              </div>
            </div>
            <div className="w-full px-8 lg:w-3/12">
              <div className="group relative flex flex-col items-center justify-center rounded-[36px] bg-white text-center shadow-none transition-all duration-300 hover:shadow-great">
                ...
                <div className="relative mb-6 inline-flex h-28">
                  <div className="absolute -left-3 top-2 z-10 translate-y-1/2 -translate-x-1/2">
                    <Image layout="fixed" width={40} height={69} src="/images/illustration-mic.png" alt="mikrofon" />
                  </div>
                ...
                <h4 className="mb-3 text-xl font-semibold text-gray-900">Mahalliy tadbirlar</h4>
                <h5 className="mb-8 px-0 text-base font-medium text-gray-500 lg:px-8">
                  O'zi foydasiz narsalarga to'la. Erkaklarga afzal, ular tinglashga berilgan.
                </h5>
              </div>
            </div>
            <div className="w-full px-8 lg:w-3/12">
              <div className="group relative flex flex-col items-center justify-center rounded-[36px] bg-white text-center shadow-none transition-all duration-300 hover:shadow-great">
                ...
                <div className="relative mb-6 inline-flex h-28">
                  <div className="absolute -right-10 top-3 z-10 translate-y-1/2 -translate-x-1/2">
                    <Image layout="fixed" width={50} height={50} src="/images/illustration-power.png" alt="sozlash" />
                  </div>
                ...
                <h4 className="mb-3 text-xl font-semibold text-gray-900">Moslashtirish</h4>
                <h5 className="mb-8 px-0 text-base font-medium text-gray-500 lg:px-8">
                  Biz harbiy mijozlar uchun aviatsiya xizmatlarini tashqi manbadan taqdim etamiz.
                </h5>
              </div>
            </div>
          </div>
      ...
      <section className="mb-28">
        <div className="relative mx-auto max-w-7xl px-4">
          <div className="mb-16 flex flex-col text-center">
            <h3 className="mb-2 text-lg uppercase text-gray-500">Eng ommabop</h3>
            <h3 className="font-serif text-4xl uppercase leading-tight text-gray-900 lg:text-5xl lg:leading-snug">
          ...
          <div className="relative flex flex-wrap space-y-5 pr-0  lg:space-y-0 lg:pr-10">
            ...
            <div className="relative z-20 w-full px-4 lg:w-4/12">
              <div className="flex flex-col rounded-3xl bg-white pb-10 shadow-great">
                <div className="relative h-96 overflow-hidden rounded-tr-3xl rounded-tl-3xl">
                  <Image layout="fill" className="object-cover object-top" src="/images/destination-1.jpg" alt="Rim" />
                </div>
                <div className="text-gray-500">
                  <div className="flex justify-between px-5 pt-7">
                    <h6 className="text-lg">Rim, Italiya</h6>
            ...
            <div className="relative z-20 w-full px-4 lg:w-4/12">
              <div className="flex flex-col rounded-3xl bg-white pb-10 shadow-great">
                ...
                <div className="text-gray-500">
                  <div className="flex justify-between px-5 pt-7">
                    <h6 className="text-lg">London, Buyuk Britaniya</h6>
                    <h6 className="text-lg">$4,2k</h6>
                  </div>
                  <div className="inline-flex items-center px-5 pt-4">
                    <span className="material-icons mr-2 text-black">near_me</span>
                    <span>12 kunlik sayohat</span>
                  </div>
                </div>
              </div>
            </div>
            <div className="relative z-20 w-full px-4 lg:w-4/12">
              <div className="flex flex-col rounded-3xl bg-white pb-10 shadow-great">
                ...
                <div className="text-gray-500">
                  <div className="flex justify-between px-5 pt-7">
                    <h6 className="text-lg">Butun Yevropa</h6>
                    <h6 className="text-lg">$15k</h6>
                  </div>
                  <div className="inline-flex items-center px-5 pt-4">
                    <span className="material-icons mr-2 text-black">near_me</span>
                    <span>28 kunlik sayohat</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-wrap space-x-4 space-y-4 lg:space-y-0 lg:space-x-0">
            <div className="w-full pl-0 lg:w-6/12 lg:pl-6">
              <div className="mb-3 flex flex-col text-left lg:mb-16">
                <h3 className="mb-2 text-lg uppercase text-gray-500">Tez va oson</h3>
                <h3 className="mb-8 font-serif text-4xl uppercase leading-tight text-gray-900 lg:text-5xl lg:leading-snug">
                  Keyingi sayohatingizni 3 oson qadamda bron qiling
                </h3>
              </div>
              <ul className="flex flex-col gap-y-8 lg:gap-y-12">
                <li className="flex items-center gap-x-5">
                  ...
                  <div className="flex flex-col leading-5">
                    <h6 className="font-bold text-gray-900">Yo'nalishni tanlang</h6>
                ...
                <li className="flex items-center gap-x-5">
                  ...
                  <div className="flex flex-col leading-5">
                    <h6 className="font-bold text-gray-900">To'lovni amalga oshiring</h6>
                    <p className="font-thin text-gray-500">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit. Urna, tortor tempus.
                    </p>
                  </div>
                ...
                <li className="flex items-center gap-x-5">
                  ...
                  <div className="flex flex-col leading-5">
                    <h6 className="font-bold text-gray-900">Tanlangan kunda aeroportga yetib oling</h6>
                    <p className="font-thin text-gray-500">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit. Urna, tortor tempus.
                    </p>
                  </div>
            ...
            <div className="flex w-full items-center justify-center lg:w-6/12">
              <div className="relative w-[370px]">
                ...
                <div className="absolute bottom-16 -right-1 z-30 w-[263px] translate-x-0 transform rounded-2xl bg-white p-4 pr-7 shadow-great lg:right-0 lg:translate-x-1/2">
                  <div className="flex">
                    ...
                    <div className="mb-2 flex w-full flex-col">
                      <span className="text-sm text-gray-500">Jarayonda</span>
                      <span className="mb-2 text-sm text-gray-900">Rimga sayohat</span>
                      <span className="mb-1 text-xs">
                        <span className="mr-1 text-accent-6">40%</span>
                        <span className="text-gray-900">Bajarildi</span>
                      </span>
                ...
                <div className="relative z-20 rounded-xl bg-white px-4 pt-4 pb-5 shadow-great">
                  ...
                  <h6 className="mb-2 text-lg font-bold text-gray-900">Gretsiyaga sayohat</h6>
                  <div className="mb-4 flex text-gray-500">
                    <h6>14-29 iyun</h6>
                    <span className="mx-2">|</span>
                    <h6>Robbin Joseph tomonidan</h6>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex space-x-3 text-gray-500">
                      ...
                      <span>24 kishi qatnashmoqda</span>
                    </div>
            ...
            <div className="relative z-20 mb-8 overflow-hidden rounded-xl rounded-tl-3xl bg-accent-4/20 pt-20 pb-20 lg:rounded-3xl lg:rounded-tl-[120px]">
              ...
              <div className="relative z-10">
                <h6 className="mb-10 px-4 text-center text-lg font-bold leading-normal text-gray-500 lg:px-36 lg:text-3xl">
                  Cobham haqida ma'lumot, so'nggi yangiliklar va boshqa qiziqarli takliflarni olish uchun obuna bo'ling
                </h6>
                <form action="" className="flex justify-center lg:space-x-5">
                  ...
                  <button className="rounded-r-lg bg-gradient-to-b from-accent-2/90 to-accent-2 py-4 px-4 text-white lg:rounded-lg lg:px-16">
                    <span className="hidden lg:block">Obuna bo'lish</span>
      ...
      <footer className="relative overflow-x-hidden pb-32">
        ...
        <div className="relative mx-auto max-w-full px-4 lg:max-w-7xl">
          <div className="mb-12 flex flex-wrap">
            <div className="w-full lg:w-3/12 lg:px-4">
              ...
              <p className="pr-8 text-sm text-gray-500">
                Sayohatingizni bir daqiqada bron qiling, ko‘proq muddat davomida to‘liq nazorat oling.
              </p>
            </div>
            <div className="w-full lg:w-6/12">
              <div className="grid grid-cols-1 gap-y-4 lg:grid-cols-3 lg:gap-y-0 lg:gap-x-4">
                <div>
                  <h6 className="mt-2 mb-6 text-xl font-semibold tracking-tight text-gray-900">Kompaniya</h6>
                ...
                <div>
                  <h6 className="mt-2 mb-6 text-xl font-semibold tracking-tight text-gray-900">Aloqa</h6>
                  <ul className="space-y-2 text-lg text-gray-500">
                    <li>
                      <Link href="/#">
                        <a>Yordam</a>
                ...
                <div>
                  <h6 className="mt-2 mb-6 text-xl font-semibold tracking-tight text-gray-900">Boshqa</h6>
                  <ul className="space-y-2 text-lg text-gray-500">
                    <li>
                      <Link href="/#">
                        <a>Aviakompaniya to'lovlari</a>
                      </Link>
                    </li>
                    <li>
                      <Link href="/#">
                        <a>Aviakompaniyalar</a>
                      </Link>
                    </li>
                    <li>
                      <Link href="/#">
                        <a>Arzon chiptalar bo'yicha maslahatlar</a>
                      </Link>
                    </li>
                  </ul>
                </div>
            ...
            <div className="mt-5 w-full lg:mt-0 lg:w-3/12">
              ...
              <h6 className="mt-7 text-xl tracking-tight text-gray-500">Ilovamizni kashf eting</h6>
          ...
          <div className="pt-8 text-center text-sm text-gray-500">Barcha huquqlar Oasis Tour</div>
        </div>
      </footer>
    </div>
  );
